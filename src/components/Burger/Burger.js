...
export default function Burger({
  ...
  return (
    <div className={styles.menu_container}>
      ...
      <div
        className={`${styles.menu_content} ${open ? styles.content_opened : ''
          }`}
        tabIndex="-1"
      >
        ...
        <div tabIndex="-1" className={styles.content_item} onClick={() => onLangChange()}>
          {change_lang}
          <div className={styles.icon_container}>
            <LanuageIcon />
          </div>
        </div>
        <div tabIndex="-1" className={styles.content_item} onClick={toggleDarkMode}>
          {change_theme}
          <div className={styles.icon_container}>
