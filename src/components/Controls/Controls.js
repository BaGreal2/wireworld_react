	...
	return (
		<div className={props.isMain ? styles.controls : styles.controls_upload}>
			<Button
				...
				tooltip={isMobile ? null : dict.start_hint}
			>
				<PlayIcon
			...
			{props.isMain && (
				<Button
					...
					tooltip={isMobile ? null : dict.clear_hint}
				>
			...
			{props.isMain && (
				<Button
					...
					tooltip={isMobile ? null : dict.reset_hint}
				>
			...
			<Dropdown
				...
				tooltip={isMobile ? null : dict.elements_hint}
			...
			{!props.isMain && (
				<>
					...
					>
						...
						>
							{props.userRated ? (
								<RetractIcon className={styles.main_buttons_icon} />
							) : (
								<StarIcon className={styles.main_buttons_icon} />
							)}
						</Button>
					</form>
				</>
